                ...
                [
                    np.stack(
                        [
                            np.array(
                                [
                                    np.array([4.22, 3.67, 4.56]),
                                    np.array([5.0, 4.44, 5.56]),
                                ],
                            )
                            for _ in range(3)
                        ],
                ...
                [
                    np.stack(
                        [
                            np.array(
                                [
                                    np.array([3.5, 3.75, 4, 4.5]),
                                    np.array([5.25, 3.75, 5.5, 5.5]),
                                ],
                            )
                            for _ in range(3)
                        ],
                ...
                [
                    np.stack(
                        [
                            np.array(
                                [
                                    np.array([4.22, 4.56, 4.33, 6.78]),
                                    np.array([5.0, 5.56, 7.11, 12.33]),
                                    np.array([5.0, 5.56, 7.89, 7.67]),
                                ],
                            )
                            for _ in range(3)
                        ],
